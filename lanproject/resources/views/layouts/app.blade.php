...
<head>
    ...
    <title>LAN | Admin Journal System Dashboard @yield('title')</title>
    @include('include.css')
    <!-- Styles -->
</head>
    ...
    <div class="wrapper">
        <header class="main-header">
          ...
          <a href="{{url('/')}}" class="logo">
            ...
            <span class="logo-mini"><b>A</b>JS</span>
            <!-- logo for regular state and mobile devices -->
            <span class="logo-lg"><b>Admin</b> Journal System</span>
          </a>
        ...
        <footer class="main-footer">
          ...
          <strong>Copyright &copy; 2017 <a href="http://rizkipadhil.dawnesia.com">LAN Journal System</a>.</strong> All rights
          reserved.
        </footer>
        <!-- Control Sidebar -->
